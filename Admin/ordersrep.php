...
<body>
	<nav class="navbar home-menu">
        ...
        <li><a href="reports.php">Reports</a></li>
		 ...
		 <table class="table">
        	<tr>
          <label class="lbl">Orders Reports </label>      
          ...
          <th><label class="lbl">Order Date</label> </th>
          <th><label class="lbl">Order Status</label> </th>
          <th><label class="lbl">Product Name </label> </th>
          <th><label class="lbl">Product Quantity </label> </th>
          <th><label class="lbl">Total Spent </label> </th>
          <th><label class="lbl">Payment_Account_Number </label> </th>
          ...
          <td>        
          <label class="lbl"><?php echo $order["status"]?>        	
          </label> 
          </td>
          ...
          <td>        
          <label class="lbl">
          <?php echo $order['payment_account'] ?>
